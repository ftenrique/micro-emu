...
export const ACTION_CATALOG: readonly ActionCatalogItem[] = [
    ...
    { id: "micro.mic", category: "Codex Micro", label: "Microphone (ACT10)", title: "Mic", description: "Press the Codex Micro microphone control (ACT10).", icon: "mic", executor: "Micro", dispatch: { kind: "encoder-button", index: 2 } },
    ...
    { id: "agent.new-task", category: "Codex workflow", label: "New task", title: "New Task", description: "Open the Codex new-task screen.", icon: "new-chat", executor: "Codex", dispatch: { kind: "codex-action" } },
